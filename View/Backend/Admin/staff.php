        ...
        <div class="staffBody">
            <div class="top flex">
                ...
                <?php 
                    ...
                    ?> 
                <p>Bonjour Vincent, avez-vous dit bonjour à l'un d'entre eux aujourd'hui ? <i class="uil uil-grin icon"></i>?</p>

                <a href="addStaff.php"><button  class="flex btn bg">
                    <i class="uil uil-plus"></i> Ajouter un nouveau
                </button></a>
            </div>
                            ...
                            if($count > 0){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="rentFee">
                                            <span class="fees flex"><i class="uil uil-award icon"></i>G.V.Parrot</span>
                                            <p>Entreprise</p>
                                        </td>
