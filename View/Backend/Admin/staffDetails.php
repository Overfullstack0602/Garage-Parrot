...
?>
    ...
    <div class="adminDasboard flex">
        ...
        <div class="staffsDetailsBody">
            <div class="top flex">
                <h1 class="titleText">
                 Les details de staff
                </h1>
                <p>Bonjour Vincent, ce membre du personnel semble prometteur. <i class="uil uil-grin icon"></i>?</p>
            ...
            <div class="headerBtns flex">
               ...
               <a href="<?php echo SITEURL?>View/Backend/Admin/deleteStaff.php?id=<?php echo $selectedID?>">
                <button  class="flex btn delBtn">
                    <i class="uil uil-trash-alt icon"></i> Supprimer staff
                </button>
               </a>
                    
                <a href="<?php echo SITEURL?>View/Backend/Admin/updateStaff.php?id=<?php echo $selectedID?>">
                    <button  class="flex btn bg">
                        <i class="uil uil-check-circle icon"></i> Mettre a jour le staff
                    </button>
                </a>
                </div>
            ...
            <div class="detailsSection">
                    ...
                    <div class="leftDiv">
                        <div class="topLeftDiv flex">
                            ...
                            <div class="staffBio">
                                ...
                                <div class="lang">
                                    Langue: <span><?php echo $language?></span>
                                </div>
                            ...
                            <div class="personalInfor">
                                ...
                                <div class="ID">
                                    Numéro ID: <span>#<?php echo $staffId?></span>
                                </div>
                                <div class="exp">
                        ...
                        <div class="topRightDiv">
                            ...
                            <span class="email flex">
                             <a href="https://mailto:<?php echo $email ?>" class="flex">
                                 <i class="uil uil-envelope-alt icon"></i>Staff email
                             </a>
                ...
                <h4 class="flex">Voitures du staff</h4>
                <p>Toutes les voitures publiée par ce staff. </p>
                    ...
                    <?php 
                        ...
                        if($res == TRUE){
                            ...
                            if($count > 0){
                                ...
                                ?>
                                <span>Aucun vehicule lié a ce staff!</span>
                                <?php
                            }
                        }
                    ?>
