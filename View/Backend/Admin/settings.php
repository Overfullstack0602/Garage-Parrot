        ...
        <div class="settingsBody">
            <div class="top flex greyBg">
                ...
                <a href="staff.php"><button  class="flex btn bg">
                    <i class="uil uil-plus"></i> tout le Staff
                </button></a>
            ...
            <div class="settingsDiv">
                <div class="adminDetails">
                    ...
                    <h3 class="detailsTitle">Details de Administrateur</h3>
                        ...
                        <div class="detaialsDiv">
                           ...
                           <div class="detailsBody flex">
                               <div class="leftDiv">
                                    ...
                                    <span class="level flex"><i class="uil uil-award icon" ></i> Administrateur</span>
                                    <p><?php echo $email;?></p>
                                ...
                                <div>
                                        ...
                                        <div class="singleDetail">
                                            <span class="label">Numéro de telephone</span>
                    ...
                    <form method="POST" class="flex" enctype="multipart/form-data">
                        ...
                        <div class="singleField">
                            <label for="phone">Niméro de téléphone</label>
                        ...
                        <div>
                            ...
                            <div class="singleField">
                                ...
                                <select name="status" id="status" value="<?php echo $status?>">
                                    ...
                                    <option value="not verified">Not verifié</option>
                                </select>
                            </div>
