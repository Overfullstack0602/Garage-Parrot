                ...
                <div class="rightDiv">
                            ...
                            ?>
                                ...
                                <div class="reminderDiv">
                                    ...
                                    <form method="POST">
                                        ...
                                        <button class="btn flex primaryBtn" name="submit"><i class="uil uil-message "></i> Envoyer</button>
                                    </form>
                                </div>
                    ...
                    <div class="divBottomSection flex">
                                       ...
                                       <div class="content grid">
                                        ...
                                        <div class="overview">
                                            ...
                                            <div class="overviewContent grid">
                                                ...
                                                <span class="span">Niveau de model: <span class="ans"><?php echo $modelgrade;?></span></span>
                                                <span class="span"> Zone de spécification: <span class="ans"><?php echo $specregion;?></span></span>
                                                <span class="span"> Reservoire: <span class="ans"><?php echo $fuel;?></span></span>
                           ...
                           <div class="reviews divBottomRightSection">
                            <h3 class="reviewTitle">Avis sur le vehicule</h3>
