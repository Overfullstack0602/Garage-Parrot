    ...
    <div class="loginPage section">
        <div class="secContainer container">
            <div class="secTitleDiv">
                <h2 class="secTitle">Connexion staff</h2>
                <P>
                    Bienvenue!
                </P>
            ...
            <div class="formSection">
                ...
                <span class="registerLink">
                    <p>Vous étes pas encore inscrit? <a href="signUp.php">Inscription</a></p>
                </span>
            </div>
        </div>
    </div>
...
if(isset($_POST['submit'])){
    ...
    if(!$res){
        die('Erreur de la base de données : ' . mysqli_error($conn));
    }
    ...
    if($count == 1 && $row['role'] == 'admin'){
        $_SESSION['loginMessage'] = '<span class="success">Bienvenue ' . $userName . '!</span>';
        ...
        $_SESSION['noAdmin'] = '<span class="fail" style="color: red;">Informations incorrectes!</span>';
